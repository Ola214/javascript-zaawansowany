...
AJAX.prototype._assignEvents = function () {
  ...
  this._xhr.addEventListener("abort", this._handleResponse.bind(this), false);
  this._xhr.addEventListener("error", this._handleResponse.bind(this), false);
  this._xhr.addEventListener("timeout", this._handleResponse.bind(this), false);
};
